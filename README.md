...
### 学習
- MVCアーキテクチャに準拠したコードにリファクタリングした。[7d189b9d91a5acbf3cf59e826982d05015b7d18f](https://github.com/k-saito-en/DestiniAPP/commit/7d189b9d91a5acbf3cf59e826982d05015b7d18f)
...
## [BMI-Calculator](https://github.com/k-saito-en/BMI-Calculator)

### 学習
- structとclassの違い
- オプショナル型を扱う際の安全確保の方法５種類
- 遷移先の画面に値を渡す方法、遷移の仕方
- ストリングフォーマットによる値の丸めかた

### 気がついたこと
- ゼロから、授業動画と並行してコーディングするのではなく、完成形を確認して意味がわからないところをまとめておいた方が効率的に学習できるのでは？
